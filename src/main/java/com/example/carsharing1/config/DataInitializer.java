...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String @NonNull ... args) {
        ...
        log.info("Создано тестовое бронирование");
